...
AI 功能通过 **Finder 智能操作菜单** 使用：选中文件后按 `Cmd+X`，若选择与上次相同则弹出菜单，选择「KIMI AI工具」即可对当前文件进行 AI 处理。

* 支持文本、图片、代码、文档等文件类型
* 可进行翻译、解释、总结、分析
* 需在「配置」中填写 Kimi API Key 后使用
...
通过网盘分享的文件：CommondX-1.0.0.dmg
链接: https://pan.baidu.com/s/1gz7p-MwhmXDOAj3Xz3lfHQ?pwd=6giw 提取码: 6giw 复制这段内容后打开百度网盘手机App，操作更方便哦

### 配置 Kimi API（可选）

如需使用 AI 功能（智能菜单中的 KIMI AI工具），需要配置 Kimi API Key：
